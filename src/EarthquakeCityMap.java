...
public class EarthquakeCityMap extends PApplet {
	...
	/** Local tiles location used for working without an Internet connection */
	...
	private void sortAndPrint(int numToPrint){
		...
		System.out.println("Output using file " + earthquakesURL + " with sortAndPrint(" + numToPrint + ")");
		System.out.println("");
	...
	private void checkCitiesForClick()
	{
		...
		// Loop earthquake markers to see if one of them is selected
	...
	*/
	...
	// and returns true.  Helper method isInCountry will
	// set this "country" property.  Otherwise it returns false.
